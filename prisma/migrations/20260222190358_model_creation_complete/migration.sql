...
-- CreateIndex
CREATE UNIQUE INDEX "Categoriy_name_key" ON "Categoriy"("name");
...
-- AddForeignKey
ALTER TABLE "Meal" ADD CONSTRAINT "Meal_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Categoriy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
